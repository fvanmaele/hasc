// Adapted from https://github.com/fvanmaele/pad-project/tree/master/symmetrize/matrix
#ifndef HASC_EX02_TRIMATRIX_HH
#define HASC_EX02_TRIMATRIX_HH
    ...
    TriMatrix(T* row_major, index_t length)
    {
        ...
        for (index_t k = 0; k < length; ++k) {
            ...
            if (i == j) {
                ...
                _l[offset_lower_col_major(i, j, _n)] = row_major[k];
            } else {
                _u[offset_upper_row_major(i, j, _n)] = row_major[k];
            }
        }
    }
