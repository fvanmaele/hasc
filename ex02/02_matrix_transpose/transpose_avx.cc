...
public:
  ...
  void run() const
  {
    transpose5_avx<M>(n, std::min(n, b), A, B);
  }
  // report number of operations for one run
  double operations() const
  {
...
public:
  ...
  void run() const
  {
    transpose6_avx<M>(n, std::min(n, b), A, B);
  }
  // report number of operations for one run
  double operations() const
  {
...
int main(int argc, char **argv)
{
  ...
  // experiment 1
  expnames.push_back("vanilla-consecutive-write-avx");
  ...
  // experiment 2
  expnames.push_back("vanilla-strided-write-avx");
  std::cout << expnames.back() << std::endl;
  ...
  //   }
  // experiment 5
  // expnames.push_back("block-consecutive_write-avx-24x4");
  // std::cout << expnames.back() << std::endl;
  ...
  // expnames.push_back("block-consecutive_write-avx-48x4");
  // std::cout << expnames.back() << std::endl;
  ...
  // expnames.push_back("block-consecutive_write-avx-96x4");
  // std::cout << expnames.back() << std::endl;
  ...
  // expnames.push_back("block-consecutive_write-avx-rowx4");
  // std::cout << expnames.back() << std::endl;
  ...
  // expnames.push_back("block-consecutive_write-avx-96x8");
  // std::cout << expnames.back() << std::endl;
  ...
  // expnames.push_back("block-consecutive_write-avx-rowx8");
  // std::cout << expnames.back() << std::endl;
  ...
  // expnames.push_back("block-consecutive_write-avx-24x24");
  // std::cout << expnames.back() << std::endl;
  ...
  // expnames.push_back("block-consecutive_write-avx-48x24");
  // std::cout << expnames.back() << std::endl;
  ...
  // expnames.push_back("block-consecutive_write-avx-96x24");
  // std::cout << expnames.back() << std::endl;
  ...
  expnames.push_back("block-consecutive_write-avx-rowx24");
  std::cout << expnames.back() << std::endl;
  ...
  // experiment 6
  // std::cout << expnames.back() << std::endl;
  // expnames.push_back("block-strided-write-avx-4x24");
  ...
  // expnames.push_back("block-strided-write-avx-4x48");
  // std::cout << expnames.back() << std::endl;
  // std::vector<double> bandwidth6b;
  // for (auto n : sizes)
  // {
  //   Experiment6<4> e(n, 48);
  //   auto d = time_experiment(e, 1000000);
  //   double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
  //   bandwidth6b.push_back(result);
  //   std::cout << result << std::endl;
  // }

  // expnames.push_back("block-strided-write-avx-4x96");
  // std::cout << expnames.back() << std::endl;
  // std::vector<double> bandwidth6c;
  // for (auto n : sizes)
  // {
  //   Experiment6<4> e(n, 48);
  //   auto d = time_experiment(e, 1000000);
  //   double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
  //   bandwidth6c.push_back(result);
  //   std::cout << result << std::endl;
  // }

  expnames.push_back("block-strided-write-avx-4xrow");
  std::cout << expnames.back() << std::endl;
  std::vector<double> bandwidth6d;
  for (auto n : sizes)
  {
    Experiment6<4> e(n, n);
    auto d = time_experiment(e, 1000000);
    double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
    bandwidth6d.push_back(result);
    std::cout << result << std::endl;
  }

  // expnames.push_back("block-strided-write-avx-8x24");
  // std::cout << expnames.back() << std::endl;
  // std::vector<double> bandwidth6e;
  // for (auto n : sizes)
  // {
  //   Experiment6<8> e(n, 24);
  //   auto d = time_experiment(e, 1000000);
  //   double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
  //   bandwidth6e.push_back(result);
  //   std::cout << result << std::endl;
  // }

  // expnames.push_back("block-strided-write-avx-8x48");
  // std::cout << expnames.back() << std::endl;
  // std::vector<double> bandwidth6f;
  // for (auto n : sizes)
  // {
  //   Experiment6<8> e(n, 48);
  //   auto d = time_experiment(e, 1000000);
  //   double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
  //   bandwidth6f.push_back(result);
  //   std::cout << result << std::endl;
  // }

  // expnames.push_back("block-strided-write-avx-8x96");
  // std::cout << expnames.back() << std::endl;
  // std::vector<double> bandwidth6g;
  // for (auto n : sizes)
  // {
  //   Experiment6<8> e(n, 96);
  //   auto d = time_experiment(e, 1000000);
  //   double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
  //   bandwidth6g.push_back(result);
  //   std::cout << result << std::endl;
  // }

  // expnames.push_back("block-strided-write-avx-8xrow");
  // std::cout << expnames.back() << std::endl;
  // std::vector<double> bandwidth6h;
  // for (auto n : sizes)
  // {
  //   Experiment6<8> e(n, n);
  //   auto d = time_experiment(e, 1000000);
  //   double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
  //   bandwidth6h.push_back(result);
  //   std::cout << result << std::endl;
  // }

  // expnames.push_back("block-strided-write-avx-24x24");
  // std::cout << expnames.back() << std::endl;
  // std::vector<double> bandwidth6i;
  // for (auto n : sizes)
  // {
  //   Experiment6<24> e(n, 24);
  //   auto d = time_experiment(e, 1000000);
  //   double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
  //   bandwidth6i.push_back(result);
  //   std::cout << result << std::endl;
  // }

  // expnames.push_back("block-strided-write-avx-24x48");
  // std::cout << expnames.back() << std::endl;
  // std::vector<double> bandwidth6j;
  // for (auto n : sizes)
  // {
  //   Experiment6<24> e(n, 48);
  //   auto d = time_experiment(e, 1000000);
  //   double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
  //   bandwidth6j.push_back(result);
  //   std::cout << result << std::endl;
  // }

  // expnames.push_back("block-strided-write-avx-24x96");
  // std::cout << expnames.back() << std::endl;
  // std::vector<double> bandwidth6k;
  // for (auto n : sizes)
  // {
  //   Experiment6<24> e(n, 96);
  //   auto d = time_experiment(e, 1000000);
  //   double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
  //   bandwidth6k.push_back(result);
  //   std::cout << result << std::endl;
  // }

  expnames.push_back("block-strided-write-avx-24xrow");
  std::cout << expnames.back() << std::endl;
  std::vector<double> bandwidth6l;
  for (auto n : sizes)
  {
    Experiment6<24> e(n, n);
    auto d = time_experiment(e, 1000000);
    double result = d.first * e.operations() * 2 * sizeof(double) / d.second * 1e6 / 1e9;
    bandwidth6l.push_back(result);
    std::cout << result << std::endl;
  }
  ...
  for (int i = 0; i < sizes.size(); i++)
  {
    ...
    // std::cout << ", " << bandwidth6b[i];
    // std::cout << ", " << bandwidth6c[i];
    std::cout << ", " << bandwidth6d[i];
    // std::cout << ", " << bandwidth6e[i];
    // std::cout << ", " << bandwidth6f[i];
    // std::cout << ", " << bandwidth6g[i];
    // std::cout << ", " << bandwidth6h[i];
    // std::cout << ", " << bandwidth6i[i];
    // std::cout << ", " << bandwidth6j[i];
    //std::cout << ", " << bandwidth6k[i];
    std::cout << ", " << bandwidth6l[i];
    std::cout << std::endl;
  }
}
